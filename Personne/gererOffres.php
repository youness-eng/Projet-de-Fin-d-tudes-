...
<body>
  ...
  <div class="rechercher-bar">
    <div>
      ...
      <h2 class="titre">Gérer offres</h2>
      <div class="aligner">
  ...
  <div class="conteneur">
    ...
    <div class="offre">
      ...
      <div class="contenu-offre">
        ...
        <a href="gererOffre/modifierOffreAdmin.php?id=<?php echo $data['id_offre'];?> " class="lien-offre">Modifier</a>
        <a href="gererOffre/supprimerOffre.php?id=<?php echo $data['id_offre'];?> " class="lien-offre" id="supprimer">Supprimer</a>
      </div>
    </div>
    ...
    <?php
      ...
      echo '<div class="aucun-offre"><em>Aucun résultat de type bien n\'a été trouvé.  !!</em></div>';
...
?>
    ...
    echo '<div class="aucun-offre-rechercher">';
    echo '<div class="aucun-offre"><em>Aucun résultat de type service n\'a été trouvé.  !!</em></div>';
    echo '<img id="img" src="../images/motRechercherInvalide.svg"></div>';
    echo '</div>';
