...
menuBtn.addEventListener('click', () => {
  if(!menuOpen) {
    ...
    offres.href = 'mesOffres.php';
    var text = document.createTextNode("Mes offres"); 
    offres.appendChild(text);
    
    var contacterAdmin = document.createElement("a");
    contacterAdmin.href = 'contacterAdmin.php';
    var text = document.createTextNode("Contacter l'administrateur"); 
    contacterAdmin.appendChild(text);
    ...
    hamburger.append(msg,offre,offres,contacterAdmin,compte,deconn);
